...
import '@uniswap/v3-core/contracts/interfaces/IAltTraderV1Pool.sol';
import '@uniswap/v3-core/contracts/interfaces/callback/IAltTraderV1SwapCallback.sol';
...
contract Quoter is IQuoter, IAltTraderV1SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IAltTraderV1Pool) {
        return IAltTraderV1Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IAltTraderV1SwapCallback
    function alttraderV1SwapCallback(
        int256 amount0Delta,
        int256 amount1Delta,
        bytes memory path
